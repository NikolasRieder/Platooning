...
void PublisherSubscriber<std_msgs::UInt16, sensor_msgs::LaserScan>::subscriberCallback(const sensor_msgs::LaserScan::ConstPtr& scan)
{
        ...
        {
                actualV = map(distanceMeasureMin, distanceMin, distanceMax, 590, 700);
        }
...
int main(int argc, char **argv)
{
        ...
        PublisherSubscriber<std_msgs::UInt16,sensor_msgs::LaserScan>geschwindigkeitRegeln("/velocity_rp","/scan",1);
        ros::spin();
